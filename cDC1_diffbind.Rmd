...
sig_peaks <- read.csv("cDC1_diffbind_significant_annotated.csv")
...
# Export
write.table(all_genes, "cDC1_sig_genes_all.txt", 
            quote=FALSE, row.names=FALSE, col.names=FALSE)
write.table(gained_genes, "cDC1_gained_genes.txt", 
            quote=FALSE, row.names=FALSE, col.names=FALSE)
write.table(lost_genes, "cDC1_lost_genes.txt", 
            quote=FALSE, row.names=FALSE, col.names=FALSE)
```
